...
const MC_DIR = path.resolve(ARGV.minecraftdir);
...
const WORK_DIR = path.resolve(ARGV.workdir);
const TEMP_DIR = path.join(WORK_DIR, ".temp");
const EXTRACTED_DIR = path.join(WORK_DIR, "extracted");
const EXTRACTED_ASSETS_DIR = path.join(EXTRACTED_DIR, "assets");
const EXTRACTED_DATA_DIR = path.join(EXTRACTED_DIR, "data");
const EXTRACTED_DATA_MINECRAFT_DIR = path.join(EXTRACTED_DATA_DIR, "minecraft");
...
ensureDirSync(EXTRACTED_ASSETS_DIR);
ensureDirSync(EXTRACTED_DATA_DIR);
ensureDirSync(EXTRACTED_DATA_MINECRAFT_DIR);
