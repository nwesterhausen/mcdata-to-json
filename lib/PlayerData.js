...
const ensureDirSync = require("./helpers/PathReference").ensureDirSync;
...
function convertPlayerdatFiles() {
  ...
  Promise.all(conversionPromises)
    .then((res) => {
      ...
      logger.verbose(`Playerdata.dat file -> json job finished. (${time})`, { domain: DOMAIN });
    })
    .catch((err) => {
