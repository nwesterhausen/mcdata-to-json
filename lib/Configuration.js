...
const ARGV = yargs
  ...
  .describe("minecraftdir", "Specify the minecraft directory, defaults to /minecraft")
  .alias("t", "minecraftdir")
  .nargs("minecraftdir", 1)
  .default("minecraftdir", "/minecraft")
  .describe("outputdir", "Specify the output directory, defaults to ./output")
  .alias("o", "outputdir")
  .nargs("outputdir", 1)
  .default("outputdir", "./output")
  .describe("workdir", "Specify a temporary work directory, defaults to ./mcdata_cache")
  .alias("w", "workdir")
  .nargs("workdir", 1)
 ...
 */
function validatePath(testpath, description) {
...
validatePath(MC_DIR, "Minecraft directory (includes worlds and server.properties).");
